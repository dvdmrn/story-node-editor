const TextBox = (sender : string, dialogue : string, delay : number) : HTMLDivElement => {
...
const OptionBox = (option : string, goto : string) : HTMLDivElement => 
{
    const optionDiv = document.createElement("div") as HTMLDivElement;
...
const SN = () : HTMLDivElement => {
    const sn = document.createElement("div") as HTMLDivElement;
